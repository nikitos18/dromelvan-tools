...
public class ParserTests {
	...
	public static class Module extends JukitoModule {
		...
		protected void configureTest() {
			File dataDirectory = new File("C:/Work/dromelvan-data/sasong1314");
	...
	// @Test
	public void parsePremierLeagueAssists(@All("PremierLeagueFile") File premierLeagueFile, PremierLeagueAssistsParser parser) throws IOException {
	...
	@Test
	public void parserSoccernetDirectories(@All("SoccernetDirectory") File soccernetDirectory, SoccernetMatchStatisticsParser parser) throws IOException {
	...
	// @Test
	public void parseSoccernetMatchStatistics(@All("SoccernetFile") File soccernetFile, SoccernetMatchStatisticsParser parser) throws IOException {
	...
	// @Test
	public void parseSkySportsRatingsFile(@All("SkySportsFile") File skySportsFile, SkySportsRatingsParser parser) throws IOException {
