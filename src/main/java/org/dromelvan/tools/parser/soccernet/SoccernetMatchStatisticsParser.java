package org.dromelvan.tools.parser.soccernet;
...
public class SoccernetMatchStatisticsParser extends MatchStatisticsHTMLFileParser {
    ...
    private PremierLeagueAssistsParser assistsParser;
    private SkySportsRatingsParser ratingsParser;
    ...
    private void parseAssists(MatchParserObject matchParserObject) {
    ...
    private void parseRatings(MatchParserObject matchParserObject) {
